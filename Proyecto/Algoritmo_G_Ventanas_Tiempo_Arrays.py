...
def ejecutar_algoritmo_python(num_pob, num_gen, pm, pc, m, num_competidores, distancias, ventanas_tiempo):
    ...
    aptitudes = np.array([costo(ind, distancias, ventanas_tiempo) for ind in poblacion])
...
def main():
    ...
    # Parámetros
    num_pob, num_gen, pm, pc, m, num_competidores = 1000, 100, 0.15, 0.9, 3, 2
    km_hr= 80
    ...
    mejor_individuo, aptitud = ejecutar_algoritmo_python(num_pob, num_gen, pm, pc, m, num_competidores, distancias, ventanas_tiempo)
